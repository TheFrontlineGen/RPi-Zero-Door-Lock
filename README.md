...
<h3>Installation:</h3>
<pre><code>// Clone the Git repository
git clone https://github.com/TheFrontlineGen/RPi-Zero-Door-Lock.git</code></pre>

<pre><code>// Update the Raspberry Pi and answer all update conformations with Yes
